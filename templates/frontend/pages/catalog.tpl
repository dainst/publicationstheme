...
<div class="page page_catalog">
	...
	<h1>{translate key="catalog.category.heading"}</h1>
	...
	{if $activeTheme->getOption('showCatalogSeriesListing') && $contextSeries|@count > 1}
		<details class="pkp_series_nav_menu" role="navigation" aria-label="{translate key="series.series"}">
			<summary>Browse by {translate key="series.series"}</summary>
			<ul>
